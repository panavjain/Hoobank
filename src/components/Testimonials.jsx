...
const Testimonials = () =>(
  <section id='clients' className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}>
    ...
    <div className='absolute z-[0] rounded-full w-[60%] h-[60%] -right-[50%] blue__gradient'/>

    <div className='flex w-full justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]'>
      <h1 className={styles.heading2}>What people are <br className='sm:block hidden'></br>saying about us</h1>
